...
<model ref="r:5e5019c5-5023-4e54-87ac-9dfa4da8f706(Accounting.sandbox)">
  ...
  <languages>
    <use id="3511d2b0-c9d7-4a02-a20b-ca10f21445c3" name="Accounting" version="-1" />
    <use id="ceab5195-25ea-4f22-9b92-103b95ca8c0c" name="jetbrains.mps.lang.core" version="1" />
  </languages>
  <imports />
  <registry>
    <language id="3511d2b0-c9d7-4a02-a20b-ca10f21445c3" name="Accounting">
      <concept id="4989694486378366301" name="Accounting.structure.Date" flags="ng" index="2zs37J">
        <property id="4989694486378366304" name="day" index="2zs37i" />
        <property id="4989694486378366312" name="year" index="2zs37q" />
      </concept>
      <concept id="4989694486378359380" name="Accounting.structure.Company" flags="ng" index="2zs5VA">
        <child id="4989694486378295797" name="vatID" index="2zsOl7" />
      </concept>
      <concept id="4989694486378295440" name="Accounting.structure.Money" flags="ng" index="2zsOgy">
      ...
      <concept id="4989694486378295434" name="Accounting.structure.InvoiceLine" flags="ng" index="2zsOgS">
      ...
      <concept id="4989694486378295351" name="Accounting.structure.Entity" flags="ng" index="2zsOi5">
        <property id="4989694486378359368" name="address" index="2zs5VU" />
      </concept>
      <concept id="4989694486378295354" name="Accounting.structure.VATIdentifier" flags="ng" index="2zsOi8">
        <property id="4989694486378354579" name="identifier" index="2zs6cx" />
      </concept>
      <concept id="4989694486378295342" name="Accounting.structure.InvoicesGroup" flags="ng" index="2zsOis">
        <child id="4989694486378295357" name="invoices" index="2zsOif" />
      </concept>
      <concept id="4989694486378295343" name="Accounting.structure.Invoice" flags="ng" index="2zsOit">
      ...
      <concept id="4989694486378295792" name="Accounting.structure.Percentage" flags="ng" index="2zsOl2">
        <property id="4989694486378389745" name="value" index="2zsth3" />
      </concept>
      <concept id="4989694486378295799" name="Accounting.structure.EntitiesGroup" flags="ng" index="2zsOl5">
  ...
  <node concept="2zsOis" id="4kYXbbAjI08">
    ...
    <node concept="2zsOit" id="4kYXbbAjI09" role="2zsOif">
      ...
      <node concept="2zsOgS" id="4kYXbbAjM1A" role="2zs1hA">
        ...
        <node concept="2zsOgy" id="4kYXbbAjM1C" role="2zsOls">
          <property role="2zsOgx" value="1000" />
          <property role="2zsOgB" value="00" />
        </node>
      </node>
      <node concept="2zs37J" id="4kYXbbAjI0a" role="2zs39l">
        <property role="2zs37i" value="20" />
        <property role="2zs37q" value="2016" />
      </node>
      <node concept="2zsOgS" id="4kYXbbAmitK" role="2zs1hA">
        <property role="2zsOgT" value="Consulting" />
        <node concept="2zsOl2" id="4kYXbbAmitL" role="2zsvgU">
          <property role="2zsth3" value="10" />
        </node>
        <node concept="2zsOgy" id="4kYXbbAmitM" role="2zsOls">
