...
<model ref="r:a1a77b74-9bf0-42b6-b313-ce4dceae6e0b(me.tomassetti.accounting.editor)">
  ...
  <node concept="24kQdi" id="4kYXbbAjr2D">
    <ref role="1XX52x" to="m5to:4kYXbbAjr2g" resolve="Money" />
    <node concept="3EZMnI" id="4kYXbbAjr2F" role="2wV5jI">
      <node concept="3F0A7n" id="4kYXbbAjr2M" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjr2j" resolve="integerPart" />
        <node concept="VechU" id="wvH1x0EsNd" role="3F10Kt">
          <node concept="3ZlJ5R" id="wvH1x0EsNg" role="VblUZ">
            <node concept="3clFbS" id="wvH1x0EsNh" role="2VODD2">
              <node concept="3clFbF" id="27EArotAQRj" role="3cqZAp">
                <node concept="2OqwBi" id="27EArotAQTp" role="3clFbG">
                  <node concept="pncrf" id="27EArotAQRi" role="2Oq$k0" />
                  <node concept="2qgKlT" id="27EArotAQZX" role="2OqNvi">
                    <ref role="37wK5l" to="td06:27EArotAQDA" resolve="color" />
                  </node>
                </node>
              </node>
            </node>
      ...
      <node concept="3F0ifn" id="4kYXbbAjr2S" role="3EZMnx">
        ...
        <node concept="VechU" id="27EArotAR5F" role="3F10Kt">
          <node concept="3ZlJ5R" id="27EArotAR5K" role="VblUZ">
            <node concept="3clFbS" id="27EArotAR5L" role="2VODD2">
              <node concept="3clFbF" id="27EArotAR6F" role="3cqZAp">
                <node concept="2OqwBi" id="27EArotAR6G" role="3clFbG">
                  <node concept="pncrf" id="27EArotAR6H" role="2Oq$k0" />
                  <node concept="2qgKlT" id="27EArotAR6I" role="2OqNvi">
                    <ref role="37wK5l" to="td06:27EArotAQDA" resolve="color" />
                  </node>
                </node>
              </node>
      ...
      <node concept="3F0A7n" id="4kYXbbAjr30" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjr2l" resolve="decimalPart" />
        <node concept="VechU" id="27EArotARbn" role="3F10Kt">
          <node concept="3ZlJ5R" id="27EArotARbO" role="VblUZ">
            <node concept="3clFbS" id="27EArotARbP" role="2VODD2">
              <node concept="3clFbF" id="27EArotARcJ" role="3cqZAp">
                <node concept="2OqwBi" id="27EArotARcK" role="3clFbG">
                  <node concept="pncrf" id="27EArotARcL" role="2Oq$k0" />
                  <node concept="2qgKlT" id="27EArotARcM" role="2OqNvi">
                    <ref role="37wK5l" to="td06:27EArotAQDA" resolve="color" />
                  </node>
                </node>
              </node>
      ...
      <node concept="3F0A7n" id="4kYXbbAjr3a" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjr2w" resolve="currency" />
      </node>
    </node>
  </node>
  <node concept="24kQdi" id="4kYXbbAjGnf">
    <ref role="1XX52x" to="m5to:4kYXbbAjGlt" resolve="Date" />
    <node concept="3EZMnI" id="4kYXbbAjGnh" role="2wV5jI">
      <node concept="3F0A7n" id="4kYXbbAjGno" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjGlw" resolve="day" />
      </node>
      <node concept="2iRfu4" id="4kYXbbAjGnk" role="2iSdaV" />
      <node concept="3F0ifn" id="4kYXbbAjGnu" role="3EZMnx">
        <property role="3F0ifm" value="/" />
        <node concept="11L4FC" id="4kYXbbAjGrx" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="11LMrY" id="4kYXbbAjGry" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0A7n" id="4kYXbbAjGnA" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjGlu" resolve="month" />
      </node>
      <node concept="3F0ifn" id="4kYXbbAjGnK" role="3EZMnx">
        <property role="3F0ifm" value="/" />
        <node concept="11L4FC" id="4kYXbbAjGpF" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="11LMrY" id="4kYXbbAjGrr" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0A7n" id="4kYXbbAjGnW" role="3EZMnx">
        <ref role="1NtTu8" to="m5to:4kYXbbAjGlC" resolve="year" />
      </node>
    </node>
  </node>
